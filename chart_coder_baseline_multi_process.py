...
from chart_coder_agent import create_code_agent, image_to_base64
...
def process_single_item(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        pred_code = process_llm_response(response.content)  # 提取代码
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(save_path, "baseline_states.npy")
